...
describe('Settings page', () => {
    it('Should have two radio buttons, one for 12-hour clock and 24-hour clock, when rendered', () => {
        render(<ThemeProvider theme={themeMap["light"]}><ManageClockSettings /></ThemeProvider>);
    ...
    it('Should use browser timezone when Use Browser Timezone is clicked', () => {
        ...
        render(<ThemeProvider theme={themeMap["light"]}><SettingsProvider handleSetTheme={jest.fn()}><ManageClockSettings /></SettingsProvider></ThemeProvider>);
